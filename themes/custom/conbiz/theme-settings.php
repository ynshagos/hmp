 ...
 */
function conbiz_form_system_theme_settings_alter(&$form, &$form_state) {
  $form['#attached']['library'][] = 'conbiz/conbiz-admin';  
  ...
  $form['header']['link_btn_header'] = array(
    ...
    '#type' => 'textfield',
    '#default_value' => theme_get_setting('text_btn_header') ? theme_get_setting('text_btn_header') : t('Free Consultation'),
  );
  /*--------- Setting Footer ------------ */
  $form['footer'] = array(
    '#type' => 'details',
